...
plt.errorbar(Nsig, rpos[:,2], yerr=rprms[:,2], fmt='gv', markersize=7 ,lw=2, label='no normalization')
...
plt.errorbar(Nsig, rwidth[:,2], yerr=rwrms[:,2], fmt='gv', markersize=7, lw=2, label='no normalization')
plt.legend(fontsize='xx-large')
plt.xlabel('Number of signal events', size='xx-large')
...
plt.errorbar(Nsig, rsig[:,2], yerr=rsrms[:,2], fmt='gv', markersize=7, lw=2, label='no normalization')
...
plt.errorbar(Nsig, rllp[:,2], yerr=rlrms[:,2], fmt='gv', markersize=7, lw=2, label='no normalization')
plt.legend(fontsize='xx-large')
plt.xlabel('Number of signal events', size='xx-large')
...
plt.errorbar(Nsig, rgsig[:,2], yerr=rgrms[:,2], fmt='gv', markersize=7, lw=2, label='no normalization')
plt.legend(fontsize='xx-large')
plt.xlabel('Number of signal events', size='xx-large')
